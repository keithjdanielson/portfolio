<div class="flex h-screen flex-col justify-between px-4 sm:h-full">
	<!-- Main content -->
	<div class="flex flex-col items-center space-y-8 sm:space-y-16">
		...
		<p class="text-center font-secondary text-xl text-background">
			keen to collaborate and bring your vision to life
		</p>
	...
	<!-- Footer -->
	<footer
		class="mx-auto mb-12 max-w-md text-center font-secondary text-sm text-background text-opacity-80 sm:mb-8"
	>
		<p>
			Site designed in
			<a
		...
		<p class="mt-2 text-xs text-background opacity-90">
			{new Date().getFullYear()} Keith Danielson. Last updated January 2025.
		</p>
	</footer>
</div>
